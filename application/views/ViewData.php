						...
						foreach ($StateData as $StateRow) {
							...
							<tr>
								...
								<td>
									...
									<button data-toggle="modal" data-target="#StateUpdateModal" class="btn btn-primary StateUpdate" data-id="<?php echo $StateRow->nm_sid;  ?>" data-sname="<?php echo $StateRow->sz_sname;  ?>"><i class="fas fa-edit" aria-hidden="true" ></i></button>
									<a href="MyController/DeleteState/<?php echo $StateRow->nm_sid;  ?>"><button class="btn btn-danger"><i class="fas fa-trash" aria-hidden="true"></i></button></a>
					...
					<tbody>
						...
						foreach ($CityData as $CityRow) {
							...
							<tr>
								...
								<td><?php echo $CityRow -> nm_sid; ?></td>
								<td>

									<button data-toggle="modal" data-target="#CityUpdateModal" class="btn btn-primary CityUpdate" data-cid="<?php echo $CityRow->nm_cid;  ?>" data-sid="<?php echo $CityRow->nm_sid;  ?>" data-cname="<?php echo $CityRow->sz_cname;  ?>"><i class="fas fa-edit" aria-hidden="true" ></i></button>
									<a href="MyController/Deletecity/<?php echo $CityRow->nm_cid;  ?>"><button class="btn btn-danger"><i class="fas fa-trash" aria-hidden="true"></i></button></a>
					...
					<form action="MyController/InsertState" method="post">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input type="text" placeholder="Enter State Name" name="txtStateName" id="txtStateName" class="form-control">
							</div>
						</div>
						<br>
						<div class="row">
					...
					<form action="MyController/InsertCity" method="post">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input type="text" name="txtCityName" id="txtCityName" placeholder="Enter City Name" class="form-control">
							</div>
						</div>
						<br>
						<div class="row">	
					...
					<form action="MyController/UpdateState" method="post">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input type="text" name="txtStateName1" id="txtStateName1" class="form-control" placeholder="Enter State Name">
							</div>
						</div>
						<br>
						<div class="row">
	...
	<script>
		$(document).ready(function(){
			...
			$('#cmbState').change(function(){
				...
				{
					$.ajax({
						url:"<?php echo base_url(); ?>MyController/fetch_city",
						method:"POST",
